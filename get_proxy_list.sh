...
set -- "${Array[9]}"
IFS="="; declare -a j=($*)
echo $content | sed "s/+${a[0]}/${a[1]}/g" | sed "s/+${b[0]}/${b[1]}/g" | sed "s/+${c[0]}/${c[1]}/g" | sed "s/+${d[0]}/${d[1]}/g" | sed "s/+${e[0]}/${e[1]}/g" | sed "s/+${f[0]}/${f[1]}/g" | sed "s/+${g[0]}/${g[1]}/g" | sed "s/+${h[0]}/${h[1]}/g" | sed "s/+${i[0]}/${i[1]}/g" | sed "s/+${j[0]}/${j[1]}/g" >> ./list/proxylist
done
